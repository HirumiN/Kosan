...
@section('content')
    ...
    <div class="relative flex flex-col gap-[30px] my-[60px] px-5">
        ...
        <form action="{{route('find-kos.result')}}" class="flex flex-col rounded-[30px] border border-[#F1F2F6] p-5 gap-6 bg-white">
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <label
                        ...
                        <img src="assets/images/icons/location.svg"
                            class="absolute flex w-5 h-5 transform -translate-y-1/2 shrink-0 top-1/2 left-5" alt="icon">
