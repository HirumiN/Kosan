        ...
        <main id="Details" class="relative flex flex-col rounded-t-[40px] py-5 pb-[10px] gap-4 bg-white z-10">
            ...
            <div id="Features" class="grid grid-cols-2 gap-x-[10px] gap-y-4 px-5">
                <div class="flex items-center gap-[6px]">
                    ...
                    <p class="text-ngekos-grey">Kota {{$boardingHouses->city->name}}</p>
                </div>
                <div class="flex items-center gap-[6px]">
            ...
            <div id="TabsContent" class="px-5">
                <div id="Bonus-Tab" class="flex flex-col gap-5 tab-content">
                    <div class="flex flex-col gap-4">
                        @foreach ($boardingHouses->bonuses as $bonus)
                ...
                <div id="Testimonials-Tab" class="flex-col hidden gap-5 tab-content">
                    <div class="flex flex-col gap-4">
                        @foreach ($boardingHouses->testimonials as $testimonial)
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                <div
                                    ...
                                    <img src="{{asset('storage/' .$testimonial->photo)}}" class="object-cover w-full h-full"
                                        alt="icon">
                                </div>
                                <div>
                ...
                <div id="Rules-Tab" class="flex-col hidden gap-5 tab-content">Lorem ipsum dolor sit amet consectetur
                    adipisicing elit. Porro, vitae.</div>
                <div id="Contact-Tab" class="flex-col hidden gap-5 tab-content">Lorem ipsum dolor sit amet consectetur
                    adipisicing elit. Porro, vitae.</div>
                <div id="Rewards-Tab" class="flex-col hidden gap-5 tab-content">Lorem ipsum dolor sit amet consectetur
                    adipisicing elit. Porro, vitae.</div>
            </div>
        </main>
            ...
            <div class="fixed bottom-5 w-full max-w-[640px] px-5 z-10">
                <div class="flex items-center justify-between rounded-[40px] py-4 px-6 bg-ngekos-black">
                    <p class="font-bold text-xl leading-[30px] text-white">
                        Rp {{ number_format($boardingHouses->price, 0, ',', '.') }}
                        <br>
                        <span class="text-sm font-normal">/bulan</span>
                    </p>
                    <a href="{{route('kos-rooms', $boardingHouses->slug)}}"
