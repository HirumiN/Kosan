                    ...
                    <a href="categories.html" class="card">
                        <div
                            ...
                            <div class="w-[70px] h-[70px] rounded-full flex shrink-0 overflow-hidden">
                                <img src="{{ 'storage/' . $category->image }}" class="object-cover w-full h-full"
                                    alt="image">
                            </div>
                ...
                <a href="details.html" class="card">
                    <div
                        ...
                        <div class="flex flex-col w-full gap-3">
                            ...
                            <hr class="border-[#F1F2F6]">
                            <p class="text-lg font-semibold text-ngekos-orange">Rp {{ number_format($boardingHouse->price, 0, ',', '.') }}<span
                                    class="text-sm font-normal text-ngekos-grey">/bulan</span></p>
                        </div>
                    </div>
                </a>
