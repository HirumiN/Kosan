            ...
            <div class="flex flex-col w-full rounded-[30px] border border-[#F1F2F6] p-4 gap-4 bg-white">
                <div class="flex gap-4">
                    <div class="flex w-[120px] h-[132px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                        <img src="{{asset('storage/'. $transaction->boardingHouse->thumbnail)}}" class="object-cover w-full h-full" alt="icon">
                    </div>
                    <div class="flex flex-col w-full gap-3">
                        ...
                        <div class="flex items-center gap-[6px]">
                            ...
                            <p class="text-sm text-ngekos-grey">{{$transaction->boardingHouse->category->name
                                }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex gap-4">
                    <div class="flex w-[120px] h-[138px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                        <img src="{{asset('storage/'. $transaction->room->images->first()->image)}}" class="object-cover w-full h-full" alt="icon">
                    </div>
                    <div class="flex flex-col w-full gap-3">
                        ...
                        <div class="flex items-center gap-[6px]">
                            ...
                            <p class="text-sm text-ngekos-grey">
                                ...
                                {{\Carbon\Carbon::parse($transaction->start_date)->addMonths($transaction->duration)->isoFormat('D MMMM YYYY')}}</p>
                            </p>
                        </div>
                    </div>
                </div>
